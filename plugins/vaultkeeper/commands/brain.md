...
description: "Wissen ins Vorderland Brain pushen — erstellt .json in der Inbox"
argument-hint: "[inhalt oder thema]"
---

# /vaultkeeper:brain

Inhalt fuer das Vorderland Brain aufbereiten und als `.json` in die Inbox schreiben.
