...
4. **Vault-Capture:** Pruefen ob in dieser Session Erkenntnisse entstanden sind die als Zettel in den SvenVault gehoeren. Falls ja, unter `05-Zettelkasten/` anlegen mit Standard-Frontmatter und Backlinks.
5. **Brain-Check:** Falls neue Zettel erstellt wurden, vorschlagen ob `/vaultkeeper:brain-scan` sinnvoll ist.
